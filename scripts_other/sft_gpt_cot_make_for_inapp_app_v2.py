...
class CoTDataGenerator:
    def __init__(self, api_key):
        ...
        self.output_dir = "data/other_for_conf_for_cot_perspectives_v000"
...
[중요 사항]
다음 대화에서 특정 발화에 대해 주어진 관점으로 추론해주세요.
...
5. 전체 대화의 맥락을 고려해서 주어진 관점에 따라 단계적으로 생각하세요.
"""
        ...
        for i, item in enumerate(data):
            ...
            for j, (utterance, label_info) in enumerate(zip(utterances, labels)):
                ...
                for k, perspective in enumerate(self.perspectives):
                    ...
                    thinking = collapse_spaces(thinking)
