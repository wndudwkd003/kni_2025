...
class CoTDataGenerator:
    def __init__(self, api_key):
        ...
        self.output_dir = "data/other_for_conf_for_cot_perspectives_no"  # 그대로 사용
...
[필수요구사항]
1. 분석 대상 발화는 {label}입니다. 발화의 정답은 명확합니다. 당신은 분석 대상 발화가 {label}이라는 정답에 도달하기 위한 중간 추론을 작성해야 합니다.
